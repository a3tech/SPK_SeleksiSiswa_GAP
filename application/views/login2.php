      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          ...
          <div class="card-group clearfix animated bounceIn">
            <div class="card p-4">
              <div class="card-body">
               <form class="form-horizontal" action="<?php echo base_url('index.php/gap_controller/login/index') ?>" method="post">
            ...
            <div class="card bg-primaryy py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
               <div class="login-logo">
                  <img class="img-responsive" src="<?php echo base_url('assets/images/spk.png') ?>" width="150" height="150" alt="Company Logo" />
                </div> 
              </div>
            </div>
          </div>
