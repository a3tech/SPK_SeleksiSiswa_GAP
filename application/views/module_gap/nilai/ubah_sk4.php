              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-edit"></i>FORM UBAH DATA NILAI MEMBACA AL-QUR'AN</div>
                  <div class="card-body">
                    <form action="<?php echo base_url('index.php/data_nilai1/update'); ?>" method="post" class="form-horizontal">
                       ...
                       <div class="form-group">
                        ...
                        <div class="controls">
                          ...
                          <select class="form-control" id="appendedInput" name="sk4">
